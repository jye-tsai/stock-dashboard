...
## 胖虎指標(v4 現況描述)
每天盤後描述五個面向的**現況**:趨勢(收盤對 20 / 60 / 120 日均線、60 日均線方向)、籌碼(外資現貨今日與 20 日累計佔成交、外資台指期多空增減、融資)、情緒(散戶多空比、P/C、VIX)、匯率(台幣、美元指數 20 日變化)、風險(近 20 日實際波動跟近 3 年比,估算接下來 20 日常見漲跌幅;只描述震幅、不代表方向)。**不合成分數、不預測漲跌、不給倉位。**
